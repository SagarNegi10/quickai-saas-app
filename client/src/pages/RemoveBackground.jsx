    ...
    <div className="h-full overflow-y-auto p-4 sm:p-6 flex flex-col sm:flex-row items-start gap-4 text-slate-700">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold">AI Background Remover</h1>
        </div>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#F6AB41] to-[#FF4938] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer disabled:opacity-70"
        >
          {loading ? (
